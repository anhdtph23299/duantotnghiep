...
<div class="deznav">
    <div class="deznav-scroll">
        <div class="main-profile">
            ...
            <h5 class="name-login-sidebar"></h5>
        </div>
        <ul class="metismenu" id="menu">
            ...
            <li>
                    <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <a href="/admin/dashboards" class="nav-text">Dashboard</a>
                    </a>
            </li>
            <li>
                    <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
...
***********************************-->
<script>
    const nameLoginHtml = '<span class="font-w400">Hello, ' + full_name + '</span>';
    $('.name-login-sidebar').html(nameLoginHtml);
    if(role === "STAFF"){
