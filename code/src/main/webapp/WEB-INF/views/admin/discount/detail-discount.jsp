                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div>Đơn tối thiểu:<span class="text-black ml-1 font-w550" id="giaTriDonToiThieu"> VNĐ</span></div>
                                    <div>Giá trị giảm tối đa:<span class="text-black ml-1 font-w550" id="giaTriGiamToiDa"> VNĐ</span></div>
                                    ...
                                    <div>Mô tả:<span class="text-black ml-1 font-w550" id="moTa"></span></div>
...
<script>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $("#maKM").text(data.maKM);
            $("#tenKM").text(data.tenKM);
            $("#nguoiTao").text(data.nguoiTao.tenNV);
            ...
            $("#giaTriGiam").text(data.giaTriGiam);
            $("#giaTriDonToiThieu").text(data.giaTriDonToiThieu);
            $("#giaTriGiamToiDa").text(data.giaTriGiamToiDa);
            $("#soLuong").text(data.soLuong);
            $("#moTa").text(data.moTa);
            var dsSanPhamKhuyenMai = data.dsSanPhamKhuyenMai;
            ...
            dsSanPhamKhuyenMai.forEach(function (item){
                cardSanPham = `
                    <div class="m-0 p-0">
                        <span class="text-black ml-4 font-w550" id="moTa">- \${item.sanPhamThuocTinh.ten}</span>
                    </div>
                `
