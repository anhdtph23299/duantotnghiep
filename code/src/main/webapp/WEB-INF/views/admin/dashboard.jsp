            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="mb-3 currency-icon" width="80" height="80"  fill="none" viewBox="0 0 512 512">
                            <circle cx="40" cy="40" r="40" fill="white"></circle>
...
<%--                                                          fill="#FF782C"></path>--%>
<%--                                                </svg>--%>
                        <svg class="mb-3 currency-icon" width="80" height="80" xmlns="http://www.w3.org/2000/svg" fill="none"  viewBox="0 0 512 512">
                            <circle cx="40" cy="40" r="40" fill="white"></circle>
                            ...
                            <div class="card-body p-3 pb-0">
                                <div class="dropdown custom-dropdown d-block tbl-orders">
                                    <div class="btn  d-flex align-items-center order-bg border-0 rounded" data-toggle="dropdown">
                                        <svg width="46" height="46" viewbox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M23.4169 0.00384778C10.7089 -0.226162 0.233857 9.88467 0.00384778 22.5831C-0.226162 35.2816 9.88467 45.7662 22.5831 45.9962C35.2816 46.2262 45.7662 36.1153 45.9962 23.4073C46.2262 10.7089 36.1153 0.224274 23.4169 0.00384778ZM22.6598 41.6835C12.3573 41.4918 4.12485 32.9623 4.31653 22.6598C4.49862 12.3573 13.0281 4.12485 23.3306 4.30694C33.6427 4.49862 41.8656 13.0281 41.6835 23.3306C41.5014 33.6332 32.9623 41.8656 22.6598 41.6835Z" fill="#FF782C"></path>
                                            <path d="M23.3019 6.22369C14.0536 6.06076 6.3962 13.4498 6.23327 22.6981C6.17864 25.6077 6.8773 28.3592 8.14427 30.7705H13.4163V14.2616C13.4163 13.2524 14.7877 12.9313 15.2334 13.837L23 29.5649L30.7667 13.838C31.2123 12.9313 32.5837 13.2524 32.5837 14.2616V30.7705H37.8395C39.0182 28.5298 39.7198 25.9997 39.7667 23.3019C39.9297 14.0536 32.5502 6.3962 23.3019 6.22369Z" fill="#FF782C"></path>
                                            <path d="M30.667 31.7289V18.3672L23.8587 32.1534C23.5367 32.808 22.4624 32.808 22.1403 32.1534L15.333 18.3672V31.7289C15.333 32.2579 14.9046 32.6872 14.3746 32.6872H9.34223C12.3237 36.8763 17.1712 39.6632 22.6981 39.7667C28.4455 39.8683 33.5747 37.0507 36.6769 32.6872H31.6254C31.0954 32.6872 30.667 32.2579 30.667 31.7289Z" fill="#FF782C"></path>
                                        </svg>
                                        <div class="text-left ml-3">
                                            <span class="d-block fs-16 text-black">Monero</span>
                                        </div>
...
>>>>>>> tuan
            ...
            <div class="col-xl-6 col-xxl-12">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card-bx stacked card">
                            <img src="<c:url value='/template/admin/images/card/card1.jpg'/>" alt="">
                            <div class="card-info">
                    ...
                    <div class="col-sm-6">
                        <div class="card-bx stacked card">
                            <img src="<c:url value='/template/admin/images/card/card2.jpg'/>" alt="">
                            <div class="card-info">
                    ...
                    <div class="col-sm-6">
                        <div class="card-bx stacked card">
                            <img src="<c:url value='/template/admin/images/card/card3.jpg'/>" alt="">
                            <div class="card-info">
                                <p class="mb-1 text-white fs-14">Main Balance</p>
                                <div class="d-flex justify-content-between">
                                    <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                    ...
                    <div class="col-sm-6">
                        <div class="card-bx stacked card">
                            <img src="<c:url value='/template/admin/images/card/card4.jpg'/>" alt="">
                            <div class="card-info">
                                <p class="mb-1 text-white fs-14">Main Balance</p>
                                <div class="d-flex justify-content-between">
                                    <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
...
<<<<<<< HEAD
                                            <img class="mb-3 rounded" src="<c:url value='/template/admin/images/contacts/Untitled-1.jpg'/>" alt="">
...
>>>>>>> tuan
                                    ...
                                    <div class="items">
                                        <div class="text-center">
<<<<<<< HEAD
                                            <img class="mb-3 rounded" src="<c:url value='/template/admin/images/contacts/Untitled-2.jpg'/>" alt="">
...
>>>>>>> tuan
                                    ...
                                    <div class="items">
                                        <div class="text-center">
<<<<<<< HEAD
                                            <img class="mb-3 rounded" src="<c:url value='/template/admin/images/contacts/Untitled-3.jpg'/>" alt="">
...
>>>>>>> tuan
                                    ...
                                    <div class="items">
                                        <div class="text-center">
<<<<<<< HEAD
                                            <img class="mb-3 rounded" src="<c:url value='/template/admin/images/contacts/Untitled-4.jpg'/>" alt="">
...
>>>>>>> tuan
                                    ...
                                    <div class="items">
                                        <div class="text-center">
<<<<<<< HEAD
                                            <img class="mb-3 rounded" src="<c:url value='/template/admin/images/contacts/Untitled-5.jpg'/>" alt="">
