                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="<c:url value='/template/web/img/product-1.jpg'/>" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="<c:url value='/template/web/img/product-2.jpg'/>" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="<c:url value='/template/web/img/product-3.jpg'/>" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="<c:url value='/template/web/img/product-4.jpg'/>" alt="Image">
                        </div>
                    </div>
