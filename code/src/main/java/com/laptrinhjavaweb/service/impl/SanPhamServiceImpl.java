...
public class SanPhamServiceImpl implements ISanPhamService{
	...
	public SanPhamDTO save(SanPhamDTO sanPhamDTO) {
		SanPham sanPham = sanPhamRepository.findBySlug(sanPhamDTO.getSlug());
		if(sanPham != null){
			return null;
		}
		sanPham = sanPhamConvert.convertToEntity(sanPhamDTO);
	...
	public SanPhamDTO findBySlug(String slug) {
		SanPham sanPham = sanPhamRepository.findBySlug(slug);
		if(sanPham == null){
			return null;
		}
		SanPhamDTO sanPhamDTO = sanPhamConvert.convertToDTO(sanPham);
		return sanPhamDTO;
	}
